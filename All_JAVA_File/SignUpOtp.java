...
public class SignUpOtp extends JFrame implements ActionListener{
   ...
   f = new JFrame("Varification otp frame");
        ...
        otpLabel.setBounds(265, 250, 170, 30);
        otpLabel.setFont(fontstyle2);
		otpLabel.setForeground(Color.black);

        otpField1 = new JTextField();
        otpField1.setBounds(155, 300, 40, 35);
        ...
        otpField2.setBounds(205, 300, 40, 35);
        ...
        otpField3.setBounds(255, 300, 40, 35);
        ...
        otpField4.setBounds(305, 300, 40, 35);
        ...
        otpField5.setBounds(355, 300, 40, 35);
        ...
        otpField6.setBounds(405, 300, 40, 35);
        ...
        send.setBounds(185, 370, 230, 50);
        send.setBorderPainted(false);
        //login.setBackground(Color.BLACK);
       // login.setForeground(Color.GRAY);
		ImageIcon icon1 = new ImageIcon(".\\All_Image\\verifyotp.png");
        send.setIcon(icon1);
        ...
        ImageIcon icon = new ImageIcon(".\\All_Image\\back1.png");
        back.setIcon(icon);
        ...
        JLabel background;
        ImageIcon img = new ImageIcon(".\\All_Image\\signotp.png");
