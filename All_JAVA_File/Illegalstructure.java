...
public class Illegalstructure extends JFrame implements ActionListener{
    ...
    Illegalstructure(String email){
        f = new JFrame("Illegalstructure");
		this.email = email;
       ...
       // areaField.setForeground(Color.white);
        ...
        JLabel background;
        ImageIcon img = new ImageIcon(".\\All_Image\\Illegalstructure.png");
		...
		if( getthana.equals("") || getarea.equals(""))
            {
                ...
                f.setVisible(false);
                Illegalstructure1 f7=new Illegalstructure1(email,getthana,getarea);
				//f7.setVisible(true);
			    }
    }
