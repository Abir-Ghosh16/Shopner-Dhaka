...
public class Garbage extends JFrame implements ActionListener{
    ...
    Garbage(String email){
        f = new JFrame("Garbage");
		this.email = email;
       ...
       // areaField.setForeground(Color.white);
        ...
        String country2[]={"Trash","Dustbin","Footpath"};        
	   ...
	   // issue.setOpaque(false);
        ...
        JLabel background;
        ImageIcon img = new ImageIcon(".\\All_Image\\Garbage.png");
		...
		if( getthana.equals("") || getarea.equals("") || getissue.equals(""))
            {
                ...
                f.setVisible(false);
              Garbage1 f7=  new Garbage1(email,getthana,getarea,getissue);
			  //f7.setVisible(true);
			    }
    }
