...
public class Publictoilet1 extends JFrame implements ActionListener {
    ...
    Publictoilet1(String email, String getthana, String getarea) {
        f = new JFrame("Publictoilet1");
        this.email = email;
        ...
        JLabel background;
        ImageIcon img2 = new ImageIcon(".\\All_Image\\Publictoilet1.png");
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
          ...
          if(sel== JOptionPane.YES_OPTION)
		  {
            ...
            if (getproblemArea.equals("")) {
                ...
                try {
                    FileWriter fw = new FileWriter(".\\All_Text_File\\Publictoilet1Problem.txt", true);
                    ...
                    Logger.getLogger(Publictoilet1.class.getName()).log(Level.SEVERE, null, ex);
                }
	  }}
