...
public class Mosquito1 extends JFrame implements ActionListener {
    ...
    Mosquito1(String email, String getthana, String getarea, String getissue) {
        f = new JFrame("Mosquito1");
        this.email = email;
        ...
        JLabel background;
        ImageIcon img2 = new ImageIcon(".\\All_Image\\Mosquito1.png");
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
          ...
          if(sel== JOptionPane.YES_OPTION)
		  {
            ...
            if (getproblemArea.equals("")) {
                ...
                try {
                    FileWriter fw = new FileWriter(".\\All_Text_File\\MosquitoProblem.txt", true);
                    ...
                    Logger.getLogger(Mosquito1.class.getName()).log(Level.SEVERE, null, ex);
                }
	  }}
