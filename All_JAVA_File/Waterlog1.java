...
public class Waterlog1 extends JFrame implements ActionListener {
    ...
    Waterlog1(String email, String getthana, String getarea) {
        f = new JFrame("Waterlog1");
        this.email = email;
        ...
        JLabel background;
        ImageIcon img2 = new ImageIcon(".\\All_Image\\Waterlog1.png");
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
          ...
          if(sel== JOptionPane.YES_OPTION)
		  {
            ...
            if (getproblemArea.equals("")) {
                ...
                try {
                    FileWriter fw = new FileWriter(".\\All_Text_File\\Waterlog1Problem.txt", true);
                    ...
                    Logger.getLogger(Waterlog1.class.getName()).log(Level.SEVERE, null, ex);
                }
	  }}
