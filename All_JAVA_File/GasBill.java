...
public class GasBill extends JFrame implements ActionListener {
	...
	String filePath = ".\\All_Text_File\\gasbill.txt";

    GasBill(String email1) {
		
		this.email1 = email1;

        f = new JFrame("GasBill");

        fontstyle = new Font("cambria", Font.PLAIN, 16);
		fontstyle1 = new Font("cambria", Font.BOLD, 30);
		
		 JLabel Label = new JLabel("Gas Bill");
        ...
        try {
            ...
            Logger.getLogger(GasBill.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == submit) {
            ...
            if (getprovider.equals("") || getbillnumber.equals("") || getamount.equals("")|| getname.equals("")) {
                ...
                try {
                    FileWriter fw = new FileWriter(".\\All_Text_File\\gasbill.txt");
        ...
        if (selectedRow != -1) {
            ...
            try {
                FileWriter fw1 = new FileWriter(".\\All_Text_File\\gasbill.txt");
