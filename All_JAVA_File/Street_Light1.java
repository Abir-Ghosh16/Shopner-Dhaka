...
public class Street_Light1 extends JFrame implements ActionListener {
    ...
    Street_Light1(String email, String getthana, String getarea, String getissue) {
        f = new JFrame("Street_Light1");
        this.email = email;
        ...
        JLabel background;
        ImageIcon img2 = new ImageIcon(".\\All_Image\\Street_Light1.png");
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
          ...
          if(sel== JOptionPane.YES_OPTION)
		  {
            ...
            if (getproblemArea.equals("")) {
                ...
                try {
                    FileWriter fw = new FileWriter(".\\All_Text_File\\Street_LightProblem.txt", true);

                    fw.write(email + "        " + getthana + "        " + getarea + "        " + getissue + "        " + getproblemArea+"        "+date+"        "+imagePath);
                    fw.write(System.getProperty("line.separator"));
                    fw.close();
                    f.setVisible(false);
                    new MainMenu(email);
                } catch (IOException ex) {
                    Logger.getLogger(Street_Light1.class.getName()).log(Level.SEVERE, null, ex);
                }
	  }}
