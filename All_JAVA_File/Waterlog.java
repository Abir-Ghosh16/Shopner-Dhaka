...
public class Waterlog extends JFrame implements ActionListener{
    ...
    Waterlog(String email){
        f = new JFrame("Waterlog");
		this.email = email;
       ...
       // areaField.setForeground(Color.white);
        ...
        JLabel background;
        ImageIcon img = new ImageIcon(".\\All_Image\\Waterlog.png");
		...
		if( getthana.equals("") || getarea.equals(""))
            {
                ...
                f.setVisible(false);
               Waterlog1 f7= new Waterlog1(email,getthana,getarea);
			   //f7.setVisible(true);
			    }
    }
