...
public class Road extends JFrame implements ActionListener{
    ...
    Road(String email){
       ...
       // areaField.setForeground(Color.white);
        ...
        String country2[]={"Manhole","Road Surface","Footpath"};        
	   ...
	   // issue.setOpaque(false);
        ...
        JLabel background;
        ImageIcon img = new ImageIcon(".\\All_Image\\Road.png");
		...
		if( getthana.equals("") || getarea.equals("") || getissue.equals(""))
            {
                ...
                f.setVisible(false);
                new Road1(email,getthana,getarea,getissue);
			    }
    }
