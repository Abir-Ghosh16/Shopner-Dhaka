...
public class EmployeeMenu extends JFrame implements ActionListener {  
	...
	EmployeeMenu(String email) {    
        f2=new JFrame("Employee Menu");
		...
		JLabel employeeDashboard = new JLabel ("Employee Dashboard");
	    employeeDashboard.setBounds(560,10,200,40);
	    employeeDashboard.setFont(fontstyle2);
	    employeeDashboard.setForeground(Color.BLACK);
	   ...
	   // logoutbutton.setBounds(5,182,182,44);
		logoutbutton.setBounds(5,84,182,44);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == roadbutton) {
			String filepath1=".\\All_Text_File\\RoadProblem.txt";
			String name1 ="Road";
			f2.setVisible(false);
            EmployeeTable f4 = new EmployeeTable(email,filepath1,name1);
		}
		else if (e.getSource() == mosquitobutton) {
			String filepath2=".\\All_Text_File\\MosquitoProblem.txt";
			String name2 ="Mosquito";
			f2.setVisible(false);
            EmployeeTable f5 = new EmployeeTable(email,filepath2,name2);
		}
		else if (e.getSource() == garbagebutton) {
			String filepath3=".\\All_Text_File\\GarbageProblem.txt";
			String name3 ="Garbage";
			f2.setVisible(false);
            EmployeeTable f6 = new EmployeeTable(email,filepath3,name3);
		}
		else if (e.getSource() == streetlightbutton) {
			String filepath4=".\\All_Text_File\\Street_LightProblem.txt";
			String name4 ="Street Light";
			f2.setVisible(false);
            EmployeeTable f7 = new EmployeeTable(email,filepath4,name4);
		}
		else if (e.getSource() == publictoiletbutton) {
			String filepath5=".\\All_Text_File\\Publictoilet1Problem.txt";
			String name5 ="Public Toilet";
			f2.setVisible(false);
            EmployeeTable2 f8 = new EmployeeTable2(email,filepath5,name5);
		}
		else if (e.getSource() == drainagebutton) {
			String filepath6=".\\All_Text_File\\DrainageProblem.txt";
			String name6 ="Drainage";
			f2.setVisible(false);
            EmployeeTable2 f9 = new EmployeeTable2(email,filepath6,name6);
		}
		else if (e.getSource() == illegalStructurebutton) {
			String filepath7=".\\All_Text_File\\IllegalstructureProblem.txt";
			String name7 ="Illegal Structure";
			f2.setVisible(false);
            EmployeeTable2 f10 = new EmployeeTable2(email,filepath7,name7);
		}
		else if (e.getSource() == waterlogbutton) {
			String filepath8=".\\All_Text_File\\Waterlog1Problem.txt";
			String name8 ="Waterlog";
			f2.setVisible(false);
            EmployeeTable2 f11 = new EmployeeTable2(email,filepath8,name8);
		}
		else if (e.getSource() == electricitybillbutton) {
		    f2.setVisible(false);
			ElectricityBill f12 = new ElectricityBill(email);
		}
        else if (e.getSource() == waterbillbutton) {
			f2.setVisible(false);
		    WaterBill f13= new WaterBill(email);
		}
		else if (e.getSource() == gasbillbutton) {
			f2.setVisible(false);
			GasBill f14= new GasBill(email);
		} 
		/*else if (e.getSource() == emergencybutton) {
		   ...
		   // Acc f6 = new Acc();
			...
			//f2.setVisible(false);
              //  Volunteer f4 = new Volunteer();
		} */
		else  if (e.getSource() == contactbutton) {
			
			    f2.setVisible(false);
                EmployeeContact f3 = new EmployeeContact(email);
