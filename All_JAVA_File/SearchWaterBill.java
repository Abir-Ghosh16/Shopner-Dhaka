...
public class SearchWaterBill extends JFrame implements ActionListener {
	...
	private float bill;
        ...
        SearchWaterBill(String email,String imagepath,String filepath) {
		this.email=email;
		this.imagepath=imagepath;
		this.filepath=filepath;
        f = new JFrame("SearchWaterBill");
