...
public class Illegalstructure1 extends JFrame implements ActionListener {
    ...
    Illegalstructure1(String email, String getthana, String getarea) {
        f = new JFrame("Illegalstructure1");
        this.email = email;
        ...
        JLabel background;
        ImageIcon img2 = new ImageIcon(".\\All_Image\\Illegalstructure1.png");
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
          ...
          if(sel== JOptionPane.YES_OPTION)
		  {
            ...
            if (getproblemArea.equals("")) {
                ...
                try {
                    FileWriter fw = new FileWriter(".\\All_Text_File\\IllegalstructureProblem.txt", true);
                    ...
                    Logger.getLogger(Illegalstructure1.class.getName()).log(Level.SEVERE, null, ex);
                }
	  }}
