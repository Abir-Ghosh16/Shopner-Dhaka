...
public class EmployeeTable2 extends JFrame implements ActionListener {
    ...
    EmployeeTable2(String email,String filePath,String name) {
        ...
        String[] column = {"Email", "Thana", "Area", "Problem Discription", "Date and Time", "Image path"};
        ...
        try {
            ...
            Logger.getLogger(EmployeeTable2.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        if (e.getSource() == remove) {
            ...
            if (selectedRow != -1) {
                ...
                try {
                           ...
                           String imagepath = tblModel.getValueAt(row, column5).toString();
