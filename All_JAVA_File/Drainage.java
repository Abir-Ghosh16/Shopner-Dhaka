...
public class Drainage extends JFrame implements ActionListener{
    ...
    Drainage(String email){
        f = new JFrame("Drainage");
		this.email = email;
       ...
       // areaField.setForeground(Color.white);
        ...
        JLabel background;
        ImageIcon img = new ImageIcon(".\\All_Image\\Drainage.png");
		...
		if( getthana.equals("") || getarea.equals(""))
            {
                ...
                f.setVisible(false);
               Drainage1 f7= new Drainage1(email,getthana,getarea);
			   //f7.setVisible(true);
			    }
    }
