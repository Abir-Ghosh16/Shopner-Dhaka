...
public class Street_Light extends JFrame implements ActionListener{
    ...
    Street_Light(String email){
        f = new JFrame("Street_Light");
		this.email = email;
       ...
       // areaField.setForeground(Color.white);
		...
		issueLabel.setForeground(Color.black);

        String country2[]={"MainRoad","Local Road","Alley"};        
	   ...
	   // issue.setOpaque(false);
        ...
        JLabel background;
        ImageIcon img = new ImageIcon(".\\All_Image\\Street_Light.png");
		...
		if( getthana.equals("") || getarea.equals("") || getissue.equals(""))
            {
                ...
                f.setVisible(false);
               Street_Light1 f7= new Street_Light1(email,getthana,getarea,getissue);
			   //f7.setVisible(true);
			    }
    }
