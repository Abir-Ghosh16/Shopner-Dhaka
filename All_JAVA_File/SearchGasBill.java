...
public class SearchGasBill extends JFrame implements ActionListener {
    ...
    SearchGasBill(String email,String imagepath,String filepath) {
		this.email=email;
		this.imagepath=imagepath;
		this.filepath=filepath;
        f = new JFrame("SearchGasBill");
