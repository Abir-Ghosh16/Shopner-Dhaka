...
public class Road1 extends JFrame implements ActionListener {
    ...
    Road1(String email, String getthana, String getarea, String getissue) {
        f = new JFrame("Road1");
        this.email = email;
        ...
        JLabel background;
        ImageIcon img2 = new ImageIcon(".\\All_Image\\Road1.png");
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
          ...
          if(sel== JOptionPane.YES_OPTION)
		  {
            ...
            if (getproblemArea.equals("")) {
                ...
                try {
                    FileWriter fw = new FileWriter(".\\All_Text_File\\RoadProblem.txt", true);
                    ...
                    Logger.getLogger(Road1.class.getName()).log(Level.SEVERE, null, ex);
                }
	  }}
