...
public class Garbage1 extends JFrame implements ActionListener {
    ...
    Garbage1(String email, String getthana, String getarea, String getissue) {
        f = new JFrame("Garbage1");
        this.email = email;
        ...
        JLabel background;
        ImageIcon img2 = new ImageIcon(".\\All_Image\\Garbage1.png");
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
          ...
          if(sel== JOptionPane.YES_OPTION)
		  {
            ...
            if (getproblemArea.equals("")) {
                ...
                try {
                    FileWriter fw = new FileWriter(".\\All_Text_File\\GarbageProblem.txt", true);
                    ...
                    Logger.getLogger(Garbage1.class.getName()).log(Level.SEVERE, null, ex);
                }
	  }}
